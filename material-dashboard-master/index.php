...
<head>
  ...
  <title>SPACE COMPLAINTS</title>
  <meta content="" name="description">

  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/Opera_Instantané_2022-04-14_214845_www.google.com-removebg-preview.png" rel="icon">
...
<body>
  ...
  <header id="header" class="fixed-top header-transparent">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.html">SPACE COMPLAINTS<span></span></a></h1>
      
      </div>
 
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero" id="hom">Home</a></li>
         
        
          <li><a class="nav-link scrollto" href="#contact" id="contac">Contact</a></li>
          <li class="dropdown"><a class="nav-link scrollto" href="#"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
            ...
            <ul>
                ...
                <li><a href="LOGENS.HTML" id="Signin">Sign up</a></li>
  ...
  <section id="hero">
    <div class="hero-container" data-aos="fade-up">
      <h1 id="welcome"> Welcome To SPACE COMPLAINTS!</h1>
      <h2 id="start"> Start With Us</h2>
      <a href="#aboutt" class="btn-get-started scrollto"><i class="bx bx-chevrons-down"></i></a>
    </div>
  </section><!-- End Hero -->
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2 id="conta"> Contact</h2>
          <p id="con">We are always ready to provide you with the highest level of support. The relationship between us and each customer is very important to us. call us..</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3 id="Adrdess">Our Address</h3>
              <p id="adr" >    University Of Ghardia</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
            <iframe class="mb-4 mb-lg-0" src="https://www.google.com/maps/place/Universit%C3%A9+de+Ghardaia,+Scientific+Zone%D8%8C+Bounoura%E2%80%AD/@32.3895298,3.7776096,17z/data=!4m2!3m1!1s0x1266818115222b1b:0xc32466bf18f1bd0d" frameborder="0" style="border:0; width: 100%; height: 384px;" allowfullscreen></iframe>
          </div>

          <div class="col-lg-6">
            <form action="\codershiyar\Squadfree\sendEmail.php" method="post" role="form" class="php-email-form">
              <div class="row">
                <div class="col-md-6 form-group">
                  <input type="text" name="name" class="inpu" id="name" placeholder="Your Name" required>
                </div>
                <div class="col-md-6 form-group mt-3 mt-md-0">
                  <input type="email" class="inpu" name="email" id="email" placeholder="Your Email" required>
                </div>
              </div>
              <div class="form-group mt-3">
                <input type="text" class="inputt" name="subject" id="subject" placeholder="Subject" required>
              </div>
              <div class="form-group mt-3">
                <textarea class="textare" name="body" rows="5" placeholder="Message" required></textarea>
              </div>
              <div class="my-3">
                <div class="loading" id="Loading">Loading</div>
                <div class="error-message"></div>
                <div class="sent-message" id="messg">Your message has been sent. Thank you!</div>
              </div>
              <div class="text-center"><button  onclick="send()"type="submit" id="sendm">Send Message</button></div>
            </form>
          </div>
  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="footer-info">
              <h3>SPACE RM</h3>
              <p class="pb-3" id="co"><em>We are always ready to provide you with the highest level of support. The relationship between us and each customer is very important to us. call us..</em></p>
              <p id="adr">
                 <br>    University Of Ghardia<br><br>
                <strong id="ca">Phone:</strong> +1 5589 55488 55<br>
                <strong id="Emaill">Email:</strong> info@example.com<br>
              </p>
          ...
          <div class="col-lg-2 col-md-6 footer-links">
            <h4>Useful Links</h4>
            <ul>
              <li><i class="bx bx-chevron-right"></i> <a href="#hero" id="home">Home</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#" id="about">About us</a></li>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>SPACE RM</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
...
</html><script>let arabic = document.getElementById("arabic");
