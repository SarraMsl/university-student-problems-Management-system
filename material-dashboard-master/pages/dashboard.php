  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white a" href="../pages/tables.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
    ...
    <div class="sidenav-footer position-absolute w-100 bottom-0 ">
      <div class="mx-3">
        <a href="logout0.php" class="btn bg-gradient-primary mt-4 w-100 "  type="button">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <ul class="navbar-nav  justify-content-end">
            <li class="nav-item d-flex align-items-center">
              <a href="C:\xampp\htdocs\Nouveau dossier\material-dashboard-master\pages\profile.php" class="nav-link text-body font-weight-bold px-0">
  ...
  ?>
          ...
          <div class="card-body">
            ...
            <hr class="dark horizontal">     
                  <h6 class="mb-0 " style="margin-left: 3%;">Teachers Add  Today</h6>
            <div class="d-flex ">
      ...
      <div style="display: flex;">
        <div class="container-fluid py-4" style="margin-left:-5%;width: 900%;">
          <div class="row">
            <div class="col-12">
              <div class="card my-4"style="margin-left:12%;width: 130%;">
                ...
                <div class="card-body px-0 pb-2">
                  <div class="table-responsive p-0">
                    <table class="table align-items-center mb-0">
                      <thead>
                        <tr>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Teachers</th>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Gender</th>
                          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Faculties</th>
                          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Department</th>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Speciality</th>
                          <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Mobile1</th>
                          <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Mobile2</th>
    ...
    if (!$conn) {
      echo "Connection failed!";
                        ...
                        $sql=$conn->query("select * from `teachers` WHERE DATE( NOW() )");
                        ...
                        <tr>
                          ...
                          <td class="align-middle text-center">
                            <span class="text-secondary text-xs font-weight-bold"> <?php echo $row['Mobile2']; ?></span>
                          </td>
    ...
    &nbsp; &nbsp; &nbsp;
        ...
        <div class="card-body">
          <p class="text-sm "></p>
          <hr class="dark horizontal">           <h6 class="mb-0 " style="margin-left: 3%;">Complain Of Today</h6>
