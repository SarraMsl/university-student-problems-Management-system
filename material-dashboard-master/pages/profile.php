                  ...
                  <li class="list-group-item border-0 d-flex p-4 mb-2 bg-gray-100 border-radius-lg">
                    <div class="d-flex flex-column">
                      <div>
                        ...
                        <br>
                      <span class="mb-2 text-xs">Username: <span class="text-dark font-weight-bold ms-sm-2"><?php echo $row['Username']; ?></span></span>
                      <span class="mb-2 text-xs">Email: <span class="text-dark font-weight-bold ms-sm-2"><?php echo $row['Email_Department']; ?></span></span>
                      <span class="mb-2 text-xs">University: <span class="text-dark ms-sm-2 font-weight-bold"><?php echo $row['University']; ?></span></span>

                      <span class="mb-2 text-xs">Facultie: <span class="text-dark font-weight-bold ms-sm-2"><?php echo $row['Facultie']; ?></span></span>
